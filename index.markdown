...
At Wayne State University I hold a full-time, non-tenure-track faculty appointment in the Department of Computer Science, teaching in the online Artificial Intelligence degree program. In Fall 2026 I am teaching **Software Engineering (CSC 4110)** and **AI Literacy (CSC 1001)**, alongside curriculum development, assessment, recruitment, and departmental service. In parallel, I work at the General Motors R&D Center on AI/ML-based vehicle health management and predictive diagnostics for energy and propulsion systems.
...
### Key Contributions
- **GraphPerf-RT**: Graph-driven performance modeling with calibrated uncertainty for OpenMP scheduling on heterogeneous embedded SoCs (Published and presented at IJCAI-ECAI 2026, AI4Tech Special Track, Bremen, Germany, acceptance rate 18.8%).
...
My research is supported by **National Science Foundation (NSF)** funding, and I contribute as a peer reviewer for journals and conferences including **ACM Transactions on Embedded Computing Systems (TECS)**, **NeurIPS 2026**, **AAAI 2026**, AISTATS, and ISPA, and as a TPC member for IWCMC 2026. Explore my [Publications](/publications) and [Projects](/projects) for more details.
